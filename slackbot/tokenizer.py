...
def test():
    test_patterns = [
        {"in": "<@U01LJNE6FC7> qr <https://google.com/>", "out": ["USERNAME", "QR", "URL"]},
        {"in": "<@U01LJNE6FC7>    ping     192.2.0.1", "out": ["USERNAME", "PING", "IPv4"]},
        {"in": "<@U01LJNE6FC7>    oji     hello world あああ", "out": ["USERNAME", "OJI", "WORD"]},
        {"in": "<@U01LJNE6FC7>  gakuseki C0117123", "out": ["USERNAME", "GAKUSEKI", "STUDENT_ID"]},
    ]
